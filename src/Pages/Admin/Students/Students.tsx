...
const Students: React.FC = () => {
  ...
  const handleActualizar = () => {
    navigate("/admin/students/update");
  };
  const handleBorrar = () => {
    navigate("/admin/students/delete");
  };
  const handleBuscar = () => {
    navigate("/admin/students/search");
  };
  const handleListar = () => {
  ...
  const modules: ModuleProps[] = [
    {
      iconType: "Registrar Estudiante",
      label: "Registrar Estudiante",
      onClick: handleRegistrar,
    },
    {
      iconType: "Actualizar Estudiante",
      label: "Actualizar Estudiante",
      onClick: handleActualizar,
    },
    {
      iconType: "Borrar Estudiante",
      label: "Borrar Estudiante",
      onClick: handleBorrar,
    },
    {
      iconType: "Buscar Estudiante",
      label: "Buscar Estudiante",
      onClick: handleBuscar,
    },
    {
      iconType: "Listar Estudiantes",
