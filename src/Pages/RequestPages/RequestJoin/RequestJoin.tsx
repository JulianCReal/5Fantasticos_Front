...
// =========================================================
// 5. COMPONENTE PRINCIPAL: RequestJoin
// =========================================================

const RequestJoin: React.FC = () => {
    ...
    const [state, setState] = useState<RequestState>({
        classId: "54321", // ID inicial (Clase a unirse)
        motive: "Dedo matricular esta materia debido a que...",
        classDetails: null,
        isLoading: false,
        error: null,
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const requestDTO = {
                userId: userId,
                requestType: "JOIN_GROUP", // ⭐ Tipo de solicitud
                details: {
            ...
            showMessage("¡Solicitud para unirse al grupo enviada exitosamente!");
        ...
        <div className="request-page-container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-grid-container">
                    ...
                    {/* Tarjeta de Clase (Ahora ocupa el 100% y usa el estilo rojo) */}
                    <ClassDetailsCard
                        title="Clase a Inscribir:"
                        className="card-new"
                    ...
                    {/* Motivo del cambio (Se coloca debajo de la tarjeta) */}
                    <div className="input-group" style={{marginTop: '-20px'}}>
                        <label htmlFor="motive" className="input-label">Motivo de la inscripción:</label>
                        <textarea
                            id="motive"
                            value={state.motive}
